...
<head>
    ...
    <link href="/mynet/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/mynet/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/mynet/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/mynet/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/mynet/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/mynet/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/mynet/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/mynet/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/mynet/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<script>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/mynet", //当前网站地址
            "APP"    : "/mynet/index.php?s=", //当前项目地址
            "PUBLIC" : "/mynet/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/mynet/Public/static/think.js"></script>
    <script type="text/javascript" src="/mynet/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<link href="/mynet/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
<?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/mynet/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
<link href="/mynet/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/mynet/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script type="text/javascript" src="/mynet/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
<script type="text/javascript">
$(function(){
	//搜索功能
